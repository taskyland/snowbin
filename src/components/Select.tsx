...
export const SelectTrigger = <T extends ValidComponent = 'button'>(
  ...
  return (
    <SelectPrimitive.Trigger
      class={cn(
        'flex h-10 w-full items-center justify-between rounded-md bg-neutral-3 dark:bg-neutral-dark-3 px-3 py-2 text-sm shadow-sm ring-offset-background transition-shadow placeholder:text-neutral-dark-5 focus:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50',
        local.class
      )}
      {...rest}
    >
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        class={cn(
          'relative z-50 min-w-[8rem] overflow-hidden rounded-md bg-neutral-3 dark:bg-neutral-dark-3 text-neutral-dark-5 dark:text-neutral-5 shadow-md data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 data-[closed]:zoom-out-95 data-[expanded]:zoom-in-95',
          local.class
        )}
        {...rest}
      >
...
export const SelectItem = <T extends ValidComponent = 'li'>(
  ...
  return (
    <SelectPrimitive.Item
      class={cn(
        'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-neutral-5 dark:focus:bg-neutral-dark-5 focus:text-neutral-dark-3 dark:focus:text-neutral-3 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        local.class
      )}
      {...rest}
    >
